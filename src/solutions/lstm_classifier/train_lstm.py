...
def main():
    ...
    # Chargement et prétraitement des données DE MONGODB 
    print(" Chargement et prétraitement des données DE MONGODB et création du modèle LSTM...")
    
    # Creation of the model LSTM
    X_train, X_test, Y_train, Y_test, tokenizer = preprocess_data(28, 5000)
    model = create_lstm_model(max_features, X_train.shape[1],Y_train,X_train)
    
    #Entrainement du modele LSTM
    print("Entrainement")
